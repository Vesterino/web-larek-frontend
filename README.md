...
#### Класс ModalProduct
Расширяет класс Component. Отвечает за отображение в модальном окне товара с детальной информацией данных категории, названия, изображения, цены и описания.
...
Поля класса:
- _category: HTMLElement - элемент разметки для установки в модальное окно карточки товара категории
- _title: HTMLElement - элемент разметки для установки в модальное окно карточки товара названия
- _image: HTMLImageElement - элемент разметки для установки в модальное окно карточки товара изображения
- _price: HTMLElement - элемент разметки для установки в модальное окно карточки товара цены
